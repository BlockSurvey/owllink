...
import QRCodePopup from "../dashboard/QRCodePopup";

export default function PublicProfile(props) {
  // Get owl link profile
  const owlLinkProfile = props["owlLinkProfile"];
  const dns = props["dns"];
  ...
  useEffect(() => {
    ...
    if (
      owlLinkProfile &&
      owlLinkProfile["settings"] &&
      owlLinkProfile["settings"]["googleAnalyticsId"]
    ) {
      ...
      gtag("js", new Date());
      gtag("config", owlLinkProfile["settings"]["googleAnalyticsId"]);
    }
  }, []);
  ...
  return (
    <>
      ...
      {/* Owl link profile */}
      {owlLinkProfile && (
        <div className={"container " + styles.root_container}>
          <div className="row">
              ...
              <div className={styles.profile_outline_box}>
                <div className={styles.profile_box}>
                  ...
                  {owlLinkProfile["image"] && (
                    <div
                      className={styles.profile_image_box}
                      style={{
                  ...
                  {/* Social icons list */}
                  {owlLinkProfile && owlLinkProfile["socialLinks"] && (
                    <ul
                      className={styles.profile_owl_link_social_icons_list_box}
                    >
                      {Constants.SOCIAL_ICONS.map(
                        (social, i) =>
                          owlLinkProfile["socialLinks"][social.type] && (
                            <li style={{ listStyle: "none" }} key={i}>
                              <a
                                className={
                                  styles.profile_owl_link_social_icon_box
                                }
                                href={
                  ...
                  {/* User links list */}
                  <ul className={styles.profile_user_links_box}>
                    {owlLinkProfile["links"] &&
                      owlLinkProfile["links"].map((link, index) => (
                        <li
                          key={index}
                          className={styles.profile_user_links_list_box}
                        >
                          {
                            // Nft link
                            link["type"] == "nft" ? (
                              <div
                                className={styles.profile_user_link_flex_box}
                                style={{
                              ...
                              >
                                ...
                                >
                                  <div
                                    className={
                                      styles.profile_nft_gallery_image_box
                                    }
                                  >
                                    {/* Data found */}
                                    {link["nfts"] &&
                  ...
                  <div className={styles.profile_owl_link_logo_box}>
                    {/* QR code icon */}
                    {owlLinkProfile["settings"] &&
                      owlLinkProfile["settings"]["showQRCode"] && (
                        <a
                          className={styles.profile_owl_link_logo_link}
                          onClick={() => {
                    ...
                    {/* Owl link logo */}
                    {(!owlLinkProfile["settings"] ||
                      owlLinkProfile["settings"]["showOwlLinkLogo"] !==
                        false) && (
                      <a
                        className={styles.profile_owl_link_logo_link}
                        href={"https://owl.link/?ref=" + dns}
                        target="_blank"
                        rel="noreferrer"
                      >
                        <svg
