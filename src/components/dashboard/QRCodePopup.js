...
export default function QRCodePopup(props) {
  // Parent parameters
  const { showQRCodePopupFlag, dns } = props;
  ...
  const downloadQRCode = () => {
    ...
    aEl.href = qrCodeURL;
    aEl.download = "OwlLink_" + (dns ? dns.replaceAll(".", "_") : "") + ".png";
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "20px", textAlign: "center" }}>
            {/* QR code */}
            <QRCode size={220} value={"https://owl.link/" + dns} />
